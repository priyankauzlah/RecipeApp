...
class MainActivity : AppCompatActivity() {
    ...
    private fun showToast(recipe: Recipe){
        Toast.makeText(this, "Your Favorite food is ${recipe.name}", Toast.LENGTH_SHORT).show()
    }
    ...
    private fun getRecipe(): ArrayList<Recipe>{
        ...
        val dataIngredients = resources.getStringArray(R.array.ingredients_food)
        val dataSteps = resources.getStringArray(R.array.steps_food)
        val dataRating = resources.getIntArray(R.array.rating_food)
